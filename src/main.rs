...
use crate::{cc_queue::CCQueue, crturn::CRTurn, lcrq::LCRQ, ms::{MSLockFree, MSLocking}, nblfq::{NBLFQDCas, NBLFQTagged}, queue::Queue, scq_cas::SCQCas, wcq::WCQ};
...
fn main() {
    ...
    let queue2 = Arc::new(CRTurn::new(num_threads + 1));
